import { IGetDivisiResponse } from "@/interfaces/api/division/query.interface";
import { IDivisiTableParams } from "@/interfaces/components/tables/divisi.interface";
...
const DivisiTable: React.FC<IDivisiTableParams> = ({
    data,
    onPageChange,
    onDeleteData,
    onEditData,
    ...
    const columnHelper = createColumnHelper<IGetDivisiResponse>();

    ...
    return (
        <>
            <Box sx={{ display: "flex" }}>
                    ...
                    <Toolbar>
                        ...
                        >
                            <Link href={"/dashboard"} className="text-xl">
                                Dashboard SPK{" "}
                                <span className="text-neutral-100 px-1 rounded-md font-bold bg-red-600">
                                    PROBAN
                                </span>{" "}
                            </Link>
                        </Typography>
                ...
                <main className="p-3 flex flex-col h-screen w-full">
                    <DrawerHeader />
                    <div className="h-full grow w-full">{children}</div>
                </main>
            </Box>
            <BaseModal
                name="modal-keluar"
            ...
            >
                <div>
                    ...
                    <div className="flex justify-end">
                        <Button
                            onClick={() => setModalOpened(undefined)}
                            color="error"
                        >
                            Batal
                        </Button>

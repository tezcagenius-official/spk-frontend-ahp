...
import {
  deleteAllPerhitunganAPI,
  deletePerhitunganAPI,
  postCreatePerhitunganAPI,
} from "./api";
...
export const useDeleteAllPerhitunganAPI = () => {
  return useMutation({
    mutationKey: ["delete all perhitungan"],
    mutationFn: () => deleteAllPerhitunganAPI().then((res) => res),
  });
};
